...
public class Constante_shooter {
    ...
    public static double ShooterKP_velo= 900, ShooterKI_velo = 0, ShooterKD_velo = 0, ShooterKF_velo = 16;
    ...
    public static double velo_shoot_bank = 1050, velo_shoot_mid = 1500, velo_shoot_far = 1500; //TUNEME
