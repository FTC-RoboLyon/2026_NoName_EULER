...
public class FRC_ALDNC_Auto_blue extends CommandOpMode {
    ...
    public void initialize() {
        ...
        schedule(new SequentialCommandGroup(
                        ...
                        new Drive_command(robot.Chassis(), -1, 0, 1050), //Aller a la pos tir mid
                        //new WaitCommand(100),
                        ...
                        new WaitCommand(100),
                new Collect_command(robot.Intake(), Intake_subsystem.WantedState.STAND_BY, robot.LED) // activer l'intake
